...
{% for post in data %} {% include post.html %} {% endfor %}
```
...
I made a custom boilerplate based on Gulp using this approach (plus a few other goodies). It's [available on Github](https://github.com/CleanCodeCreature/static-prototype-kit), feel free to use/extend it anyway you want.
