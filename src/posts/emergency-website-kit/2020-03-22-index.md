...
Like so many others, I'm currently in voluntary quarantine at home - and I used some time this weekend to put a small [boilerplate](https://github.com/CleanCodeCreature/emergency-site) together for this exact usecase.
...
{% callout "info" %}
You can find the full [project source on Github](https://github.com/CleanCodeCreature/emergency-site) as well as a [demo site here](https://emergency-site.netlify.app/).
{% endcallout %}
